  ...
  <div class="project-intro mt-20 mb-20">
    ...
    >
      ...
      <div class="project-overview mt-10 md:mt-0">
        ...
        <p class="desc body">
          This project, a collaboration with Allegion's Zentra team, addresses a common pain point for apartment residents and property managers: a lack of after-hours service. 
          <br/><br/>Our primary goal was to find a new revenue stream for Zentra's multi-family property management product that also provides value to customers.
        </p>
      </div>
    </div>
    ...
    <div class="project-step-row px-[7vw] mb-20">
      ...
      <div class="project-step-col-2">
        <p class="desc body">
          Our initial research revealed that residents frequently face issues with gaining access to 
          their apartments after office hours when they lose or misplace their keys. 
      ...
      <div class="project-step-row">
        ...
        <div class="project-step-col-2">
          <p class="desc body mb-15">
            We developed KeyAsk, a self-service kiosk with a pay-per-use business model. 
            The kiosk dispenses NFC-based access tags to residents who are locked out after 
            office hours. <br/><br/>KeyAsk also includes solutions for two additional access issues:
          </p>
          <div class="point-breakdown mb-8">
            ...
            <p class="point-desc body font-light">
              Guests can use the mobile app and kiosk to receive temporary access for parking.
            </p>
          </div>
          <div class="point-breakdown">
            ...
            <p class="point-desc body font-light">
              The kiosk can provide temporary access to various building amenities for guests.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="ghost-loader relative  z-0">
      ...
      <div class="project-step-col-1 ">
        <div class="header-detail bg-[var(--feather-xlight)] overflow-hidden relative">
          <h3 class="detail-name title-1 h-20 font-bold mb-8 opacity-0">o1. research</h3><div class="shine-l"></div>
        </div>
      </div>
      <div class="project-step-col-2 bg-[var(--feather-xlight)] overflow-hidden relative">
        <p class="desc body opacity-0">
          Our literature review showed that while technology in event management
          exists, persistent problems remain.
          ...
          revenue.Our literature review showed that while technology in event management
          exists, persistent problems remain.
          <br /><br />We found that integrating a comprehensive solution can
          help venues save time and resources, directly leading to increased
          revenue.
