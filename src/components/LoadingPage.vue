...
<template>
  ...
  >
    <div class="main-cont">
      <div
        class="line absolute w-screen top-[50%] left-0 bg-[var(--pearl)]"
      ></div>
      <h1
        class="scramblename major-mono-display text-center overflow-hidden md:text-9xl text-5xl"
      >
        NIKHIL
      </h1>
      <h1
      ...
      <div
        class="wiper absolute w-screen h-screen top-0 left-0 bg-[var(--pearl)]"
      ></div>
    </div>
  </div>
</template>
